...
!(function (e, t) {
  ...
  function _(e, t = "Assertion failed") {
    if (!e) {
  ...
  function D(e, t, s) {
    if (Array.isArray(e)) return void e.forEach((e) => D(e, t));
    const r = Array.isArray(t) ? t : t.split(/\s+/u);
    let n = r.length;
    for (; n--; ) Q(e, r[n]) || z(e, r[n], s);
  }
  function V(e, t, s) {
    if (Array.isArray(e)) return void e.forEach((e) => V(e, t, s));
    const r = Array.isArray(t) ? t : t.split(/\s+/u);
    let n = r.length;
    for (; n--; ) Q(e, r[n]) && H(e, r[n], s);
  }
  function Q(e, t) {
    return e.classList ? e.classList.contains(t) : G(t).test(e.className);
  }
  function B(e, t) {
  ...
  function z(e, t, s) {
    e.classList
      ...
      s && O(s) && window.setTimeout(() => H(e, t), s);
  }
  function H(e, t, s) {
    e.classList
      ? e.classList.remove(t)
      : (e.className = e.className.replace(G(t), " ").trim()),
      s && O(s) && window.setTimeout(() => z(e, t), s);
  }
    ...
    createControl() {
      ...
      return (
        this.options.targetType === T
          ? ((t = `${K.namespace} ${K.inputText.container}`),
            (e = U(["div", { id: q.containerId, classname: t }], J.input)),
            (s = {
              container: e,
              control: e.querySelector(`.${K.inputText.control}`),
              label: e.querySelector(`.${K.inputText.label}`),
              input: e.querySelector(`.${K.inputText.input}`),
              search: e.querySelector(`.${K.inputText.search}`),
              result: e.querySelector(`.${K.inputText.result}`),
            }),
            (s.label.innerHTML = this.options.label))
          : ((t = `${K.namespace} ${K.glass.container}`),
            (e = U(["div", { id: q.containerId, classname: t }], J.glass)),
            (s = {
              container: e,
              control: e.querySelector(`.${K.glass.control}`),
              button: e.querySelector(`.${K.glass.button}`),
              input: e.querySelector(`.${K.glass.input}`),
              search: e.querySelector(`.${K.glass.search}`),
              result: e.querySelector(`.${K.glass.result}`),
            })),
  ...
  class ne {
    constructor(e, t) {
      (this.Base = e),
        (this.layerName = M("geocoder-layer-")),
        (this.layer = new h.default({
          name: this.layerName,
          source: new m.default(),
    ...
    setListeners() {
      const e = (e) => {
        e.stopPropagation(),
          Q(this.els.control, re.glass.expanded)
            ? this.collapse()
            : this.expand();
      };
        ...
        this.els.input.addEventListener(
          ...
          (e) => {
            0 !== e.target.value.trim().length
              ? V(this.els.search, re.hidden)
              : D(this.els.search, re.hidden);
          },
          !1
        ),
    ...
    createFeature(e) {
      const t = new y.default(new g.default(e));
      return (
        this.addLayer(),
        t.setStyle(this.options.featureStyle),
        t.setId(M("geocoder-ft-")),
    ...
    addressTemplate(e) {
      ...
      return (
        e.name &&
          t.push(['<span class="', re.road, '">{name}</span>'].join("")),
        ...
        (e.state || e.country) &&
          t.push(
            ['<span class="', re.country, '">{state} {country}</span>'].join("")
          ),
        B(t.join("<br>"), e)
      );
    }
    ...
    expand() {
      V(this.els.input, re.spin),
        D(this.els.control, re.glass.expanded),
    ...
    collapse() {
      (this.els.input.value = ""),
        this.els.input.blur(),
        D(this.els.search, re.hidden),
        V(this.els.control, re.glass.expanded),
        this.clearResults();
    }
    listenMapClick() {
  ...
  class oe extends d.default {
    constructor(e = C, t) {
      _("string" == typeof e, "@param `type` should be string!"),
        _(
          e === C || e === j,
      ...
      const s = {
        ...
        featureStyle: [
          new u.default({
            image: new p.default({ scale: 0.7, src: "./resources/marker.png" }),
          }),
        ],
        ...t,
      };
      ...
      (this.options = s),
        (this.container = r),
        e === C && ((n = new ne(this, o.els)), (this.layer = n.layer));
    }
    getLayer() {
      return this.layer;
    }
