        ...
        function (e, t) {
          ...
          function o(e) {
            ...
            function n(t, n) {
              function o(t, r) {
                t &&
                  (console.log("Autocomplete source error.", t, e), n(t, []));
          ...
          function i(e) {
            ...
            function E(e, t) {
              if (pt.anchor) {
                var n = (I() ? Jt.filterAnchoredText : Jt.filterAnchoredHTML)(
                  e,
                  t
                );
                ...
                for (var t = e.firstChild, r = 0; t; )
                  r >= Lt
                    ...
                    : (C["default"].fabricate(t, "horsey-filter"),
                      -1 === t.className.indexOf("sey-hide") &&
                        (r++, Tt && b(t, n))),
                    (t = t.nextSibling);
                return r;
              }
            ...
            function ft(t) {
              var n = e.value,
                ...
                u = i + t + " ";
              (e.value = u + a),
                p["default"](e, { start: u.length, end: u.length });
            }
            function lt() {
              throw new Error(
              ...
              function p() {
                ...
                if (e.rangeCount) {
                  var t = e.getRangeAt(0),
                    n =
                      "P" === t.startContainer.nodeName && 0 === t.startOffset;
                  if (n)
                    return {
                  ...
                  if (t.getClientRects) {
                    ...
                    if (r.length > 0)
                      return { x: r[0].left, y: r[0].top, absolute: !0 };
                  }
                }
                return { x: 0, y: 0 };
              }
      ...
      29: [
        function (e, t) {
          ...
          function r(e) {
            function t(t, r) {
              return (
                n !== e && (n ? n.focus() : e.blur()), { start: t, end: r }
              );
            }
